...
| `FloatingActionButton` | `@workspace/ui/components/floating-action-button` | Contraparte móvil de la acción principal de una pantalla. Reserva espacio bajo el contenido; usar `withSpacer={false}` en superficies que ya ocupan el viewport y desplazan por su cuenta.                                                                                                                                                                                                                  |
