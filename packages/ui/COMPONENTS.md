...
| `CardGrid`                                                 | `@workspace/ui/components/card-grid`           | Rejilla de tarjetas: dos por fila en móvil y `layout` `2`, `md-3`, `xl-3`, `xl-4` o `xl-5` para el número de columnas en pantallas anchas.                                                                                                                                                                   |
