...
declare const messages: {
  ...
  "adminEmailTemplates": {
    "actions": "Acciones",
    "activeHint": "Si la desactivas, este correo usa los textos por defecto en este idioma.",
    "activeTitle": "Personalización activa",
    "all": "Todos",
    ...
    "defaultCopy": "Texto por defecto",
    "defaultCopyHint": "Se usa en todos los idiomas que no tengan una versión propia.",
    "edit": "Editar",
    "email": "Correo",
    ...
    "noMatches": "No hay coincidencias",
    "notice": "Aviso final",
    "overrideCount": "{count, plural, one {# idioma propio} other {# idiomas propios}}",
    "overrideHint": "Solo afecta a este idioma. Si lo dejas sin personalizar, se usa el texto por defecto.",
  ...
  "adminLanguages": {
    ...
    "activated": "Idioma activado.",
    "activeColumn": "Activo",
    "activeSwitch": "Activar {name}",
    "addLanguage": "Añadir idioma",
    "addLanguageHint": "Elige un idioma del catálogo; los textos salen del idioma fuente hasta que los traduzcas.",
    "backToLanguages": "Idiomas",
    "base": "Base",
    "cancel": "Cancelar",
    "catalogEmpty": "No quedan idiomas por añadir con esa búsqueda.",
    "catalogSearchPlaceholder": "Buscar idioma…",
    "created": "Idioma añadido.",
    "deactivated": "Idioma desactivado.",
    "default": "Por defecto",
    "defaultChanged": "Idioma por defecto actualizado.",
    "delete": "Eliminar",
    "deleteDescription": "Se eliminará {name} con todas sus traducciones. Esta acción no se puede deshacer.",
    "deleteTitle": "¿Eliminar idioma?",
    "deleted": "Idioma eliminado.",
    "directionColumn": "Dirección",
    "editHint": "Mantén los argumentos {'{'}como_este{'}'} del texto original; sin ellos el mensaje pierde sus datos.",
    "editKey": "Editar {key}",
    "editTitle": "Editar traducción",
    "editTranslations": "Traducciones",
    "emptyDescription": "Añade un idioma para empezar a traducir la interfaz.",
    "emptyTitle": "Sin idiomas",
    "exportJson": "Exportar JSON",
    "filterAll": "Todas",
    "filterMissing": "Sin traducir",
    "forbiddenDescription": "Tu cuenta no tiene acceso a los idiomas de la plataforma.",
    "forbiddenTitle": "Acceso restringido",
    "importDone": "{imported, plural, one {# traducción importada} other {# traducciones importadas}}.",
    "importInvalid": "El archivo no es un JSON de traducciones válido.",
    "importJson": "Importar JSON",
    "importPartial": "{imported, plural, one {# importada} other {# importadas}}; {rejected, plural, one {# rechazada} other {# rechazadas}}.",
    "itemLabel": "traducciones",
    "keyColumn": "Clave",
    "languageColumn": "Idioma",
    "loadFailedDescription": "No se pudieron cargar los idiomas. Inténtalo de nuevo.",
    "loadFailedTitle": "Error al cargar",
    "loading": "Cargando idiomas…",
    "ltr": "Izquierda a derecha",
    "makeDefault": "Hacer por defecto",
    "missingValue": "Sin traducir",
    "noResultsDescription": "Ninguna clave coincide con la búsqueda o el filtro.",
    "noResultsTitle": "Sin resultados",
    "notFoundDescription": "Ese idioma no existe o fue eliminado.",
    "notFoundTitle": "Idioma no encontrado",
    "pageDescription": "Idiomas de la interfaz y sus traducciones. Los compradores añaden idiomas sin tocar código",
    "pageTitle": "Idiomas",
    "progressColumn": "Progreso",
    "progressValue": "{translated, number} / {total, number}",
    ...
    "translationsDescription": "Texto original y traducción de cada clave de {name}",
    "translationsSearchLabel": "Buscar traducciones",
    "translationsSearchPlaceholder": "Buscar clave o texto…",
    "translationsTitle": "Traducciones · {name}",
    "valueColumn": "Traducción"
  },
  "adminManualPayments": {
  ...
  "adminOperations": {
    ...
    "field": {
      "code": "Código",
      "creditUnits": "Créditos a conceder",
      "credits": "Créditos",
    ...
    "fieldActionHint": "Completa los campos para ejecutar la acción.",
    ...
    "rowAction": {
      ...
      "impersonate": "Ver como el usuario",
  ...
  "adminRoles": {
    ...
    "cancel": "Cancelar",
    "candidateSearchPlaceholder": "Buscar usuario por nombre o correo…",
    "createRole": "Nuevo rol",
    "deleteDescription": "Se eliminará el rol {name}. Sus miembros perderán el acceso al panel de administración.",
    "deleteRole": "Eliminar",
    "deleteTitle": "¿Eliminar rol?",
    "deleted": "Rol eliminado.",
    "description": "Descripción",
    "editRole": "Editar rol",
    "emptyDescription": "Crea un rol para dar acceso parcial al panel de administración.",
    "emptyTitle": "Sin roles",
    "forbiddenDescription": "Tu cuenta no tiene acceso a los roles de administrador.",
    "forbiddenTitle": "Acceso restringido",
    "loadFailedDescription": "No se pudieron cargar los roles. Inténtalo de nuevo.",
    "loadFailedTitle": "Error al cargar",
    "loading": "Cargando roles…",
    "manage": "Gestionar",
    "manageMembers": "Miembros",
    "memberAssigned": "Rol asignado.",
    "memberCount": "{count, plural, one {# miembro} other {# miembros}}",
    "memberUnassigned": "Rol retirado.",
    "membersColumn": "Miembros",
    "membersHint": "Quien tenga este rol entra al panel de administración solo con sus permisos.",
    "membersTitle": "Miembros de {name}",
    "modules": {
      "affiliate": "Afiliados",
      "ai": "IA",
      ...
      "teams": "Equipos",
      "user-report": "Reporte de usuarios",
      "user-roles": "Roles de administrador",
      "users": "Usuarios"
    },
    "name": "Nombre",
    "nameRequired": "El rol necesita un nombre.",
    "noCandidates": "Ningún usuario coincide con esa búsqueda.",
    "noMembers": "Este rol aún no tiene miembros.",
    "pageDescription": "Roles con permisos parciales sobre el panel de administración",
    "pageTitle": "Roles de administrador",
    "permissionCount": "{count, plural, one {# permiso} other {# permisos}}",
    "permissions": "Permisos",
    "permissionsColumn": "Permisos",
    "permissionsHint": "Ver permite abrir el módulo; Gestionar permite cambiarlo.",
    ...
    "sheetDescription": "El rol define qué módulos puede ver y gestionar quien lo tenga.",
    "view": "Ver"
  },
  "adminSettings": {
    "analytics": {
    ...
    "publicSite": {
      "description": "Controla qué muestra el sitio público y cuánto contenido aparece en la portada",
      "docsUrl": "Dirección de la documentación",
      "docsUrlHint": "Si la rellenas, el pie del sitio público enlaza a tu documentación. Déjala vacía para no mostrar el enlace.",
      "featuredFaqsLimit": "Preguntas en la portada",
      "featuredPlansLimit": "Planes en la portada",
      "landingEnabled": "Mostrar la portada",
      "landingEnabledHint": "Al desactivarla, la dirección raíz lleva al panel en vez de al sitio público. El blog, los precios y las páginas legales siguen accesibles.",
      "latestPostsLimit": "Entradas del blog en la portada",
      "limitsHint": "Cuántos elementos se muestran en la portada, como máximo.",
      "showBlog": "Sección de blog",
      "showContact": "Página de contacto",
      "showContactHint": "Usa el correo, el teléfono y el horario de Configuración general.",
      "showFaqs": "Sección de preguntas",
      "showLanguages": "Sección de idiomas",
      "showPricing": "Sección de precios",
      "title": "Sitio público"
    },
    "saveChanges": "Guardar cambios",
  ...
  "adminTeams": {
    "accountsColumn": "Cuentas",
    "actionsColumn": "Acciones",
    "actionsFor": "Acciones para {name}",
    "averageMembers": "Miembros promedio",
    "averageMembersHint": "Miembros por workspace.",
    "connectedAccounts": "Cuentas conectadas",
    "connectedAccountsHint": "Cuentas sociales conectadas en total.",
    "cancel": "Cancelar",
    "createdColumn": "Creado",
    "emptyDescription": "Ningún workspace coincide con la búsqueda.",
    "emptyTitle": "Sin resultados",
    "forbiddenDescription": "Tu cuenta no tiene acceso a los equipos.",
    "forbiddenTitle": "Acceso restringido",
    "itemLabel": "workspaces",
    "loadFailedDescription": "No se pudieron cargar los equipos. Inténtalo de nuevo.",
    "loadFailedTitle": "Error al cargar",
    "loading": "Cargando equipos…",
    "manageModules": "Administrar módulos",
    "membersColumn": "Miembros",
    "noPlan": "Sin plan",
    "moduleNotInPlan": "No incluido en el plan",
    "modulesDescription": "Define qué herramientas puede usar {name}.",
    "modulesHint": "El plan fija el máximo disponible; aquí puedes desactivar módulos para este workspace.",
    "modulesLabel": "Módulos habilitados",
    "modulesTitle": "Módulos · {name}",
    "modulesUpdated": "Módulos del workspace actualizados.",
    "ownerColumn": "Propietario",
    "pageDescription": "Workspaces de la plataforma con su dueño, plan y tamaño",
    "pageTitle": "Equipos",
    "personal": "Personal",
    "planColumn": "Plan",
    "searchLabel": "Buscar equipos",
    "searchPlaceholder": "Buscar por nombre, slug o dueño…",
    "saveModules": "Guardar cambios",
    "savingModules": "Guardando…",
    "teamColumn": "Workspace",
    "teamWorkspaces": "De equipo",
    "teamWorkspacesHint": "Workspaces que no son personales.",
    "totalWorkspaces": "Workspaces",
    "totalWorkspacesHint": "Todos los workspaces de la plataforma.",
    "workspaceFallback": "este workspace"
  },
  "adminUserReport": {
    "byLocale": "Usuarios por idioma",
    "byMonth": "Altas por mes",
    "byPlan": "Workspaces por plan",
    "forbiddenDescription": "Tu cuenta no tiene acceso al reporte de usuarios.",
    "forbiddenTitle": "Acceso restringido",
    "growth": "Crecimiento 30 días",
    "growthHint": "Frente a los 30 días anteriores.",
    "growthValue": "{value, number}%",
    "loadFailedDescription": "No se pudo cargar el reporte. Inténtalo de nuevo.",
    "loadFailedTitle": "Error al cargar",
    "loading": "Cargando reporte…",
    "newUsers": "Nuevos (30 días)",
    "newUsersHint": "Altas de los últimos 30 días.",
    "noData": "Sin datos todavía.",
    "noPlan": "Sin plan",
    "pageDescription": "Altas, idiomas, planes y verificación de los usuarios de la plataforma",
    ...
    "statusColumn": "Estado",
    "totalUsers": "Usuarios",
    "totalUsersHint": "Usuarios registrados sin contar administradores.",
    "unverifiedBadge": "Sin verificar",
    "userColumn": "Usuario",
    "verified": "Verificados",
    "verifiedBadge": "Verificado",
    "verifiedHint": "Con el correo verificado."
  },
  "affiliate": {
  ...
  "aiAgents": {
    "canvas": {
      "disabled": "Inactivo",
      "editAgent": "Editar {name}",
      "hint": "Arrastra los nodos para reorganizar; los cambios se guardan solos.",
      "loadFailedDescription": "No pudimos cargar los agentes.",
      "loadFailedTitle": "Agentes no disponibles",
      "model": "Modelo",
      "modelMissing": "Sin modelo",
      "retry": "Reintentar",
      "triggerDescription": "Mensaje del usuario en AI Studio",
      "triggerName": "Chat del Portal"
    },
    "editor": {
      "description": "Define el nombre, el system prompt, el modelo y las herramientas de este agente.",
      "descriptionLabel": "Descripción",
      "enabled": "Activo",
      "model": "Modelo",
      "name": "Nombre",
      "parameters": "Parámetros",
      "positionFailed": "No pudimos guardar la posición del nodo.",
      "save": "Guardar",
      "saveFailed": "No pudimos guardar el agente.",
    ...
    "tools": {
      ...
      "save_caption": "Guardar caption",
      "save_file": "Guardar en Files",
      "schedule_post": "Programar publicación",
      "search_captions": "Buscar captions",
      "search_content": "Buscar contenido previo"
    }
  },
  "aiReport": {
    "apply": "Aplicar",
  ...
  "aiStudio": {
    "chat": {
      ...
      "optionCount": "{label} · {count, number}",
    ...
    "tools": {
      "agent": {
        "description": "El orquestador delega tu petición al agente adecuado.",
        "label": "Asistente",
        "placeholder": "Pide lo que necesites; el asistente decide qué agente lo hace…",
        "promptLabel": "Petición"
      },
      "content": {
  ...
  "errors": {
    ...
    "AUTH_ADMIN_PERMISSION_REQUIRED": "Tu rol no tiene permiso para esta sección.",
    ...
    "BILLING_CHECKOUT_UNAVAILABLE": "El checkout no está disponible en este momento.",
    "BILLING_OWNER_REQUIRED": "Solo el propietario del workspace puede gestionar la facturación.",
    "BILLING_PLAN_CHANGE_UNAVAILABLE": "Los cambios entre suscripciones activas se gestionan por soporte.",
    "BILLING_PLAN_CURRENT": "Este ya es el plan actual del workspace.",
    "BILLING_PLAN_NOT_FOUND": "Ese plan no está disponible para checkout.",
    ...
    "LANGUAGE_NOT_FOUND": "Ese idioma no existe.",
    "LANGUAGE_NOT_REMOVABLE": "Los idiomas base y el idioma por defecto no se pueden eliminar.",
    ...
    "ONLINE_MEDIA_BINARY_INVALID": "El proveedor devolvió un archivo que no podemos guardar.",
    "ONLINE_MEDIA_IMPORT_FAILED": "No pudimos guardar este medio en tu biblioteca.",
    "ONLINE_MEDIA_PROVIDER_FAILED": "El proveedor de medios no respondió. Inténtalo de nuevo.",
    "ONLINE_MEDIA_TOO_LARGE": "Ese medio supera el tamaño máximo de importación.",
    ...
    "TRANSLATION_KEY_UNKNOWN": "Esa clave no existe en el catálogo.",
  ...
  "files": {
    ...
    "online": {
      ...
      "providedBy": "Contenido proporcionado por {provider}",
      "resultsCount": "{count, plural, one {# resultado} other {# resultados}}",
  ...
  "impersonation": {
    "leave": "Volver al panel",
    "leaveFailed": "No se pudo salir de la vista de usuario.",
    "viewingAs": "Estás viendo el Portal como {name}."
  },
  "infrastructure": {
    "cache": {
  ...
  "integrations": {
    ...
    "pexels": {
      ...
      "apiKeyConfiguredHint": "Déjalo vacío para conservar la clave actual o escribe una nueva para reemplazarla.",
      "apiKeyHint": "Copia aquí la clave generada en tu cuenta de desarrollador de Pexels.",
      "apiKeyRequired": "La API Key de Pexels es obligatoria.",
      "availabilityHint": "Permite buscar e importar contenido de Pexels desde Files.",
      "content": "Contenido",
      "description": "Búsqueda e importación de imágenes y videos gratuitos para Files.",
      "enableAria": "Habilitar Pexels",
      "imagesAndVideos": "Imágenes y videos",
      "loadFailed": "No fue posible cargar la configuración de Pexels.",
      "saveFailed": "No pudimos guardar la configuración de Pexels.",
      "saved": "Configuración de Pexels guardada.",
      "sheetDescription": "Define la clave que habilita la búsqueda de contenido gratuito en el Portal.",
      "sheetTitle": "Configurar Pexels",
      "testDraft": "Probar borrador",
      "testDraftHint": "Comprueba la clave directamente con Pexels antes de habilitarla.",
      "testFailed": "Pexels rechazó la clave o no respondió. Revisa la configuración.",
      "testOk": "Pexels validó la clave. Ya puedes guardar y habilitar la integración.",
      "unavailable": "Pexels no disponible"
    },
    "polar": {
  ...
  "marketing": {
    ...
    "blog": {
      ...
      "next": "Siguiente",
      "noResults": "No encontramos entradas para «{query}».",
      "notFound": "Entrada no encontrada",
      "previous": "Anterior",
      "range": "{from, number}-{to, number} de {total, number}",
      "related": "Seguir leyendo",
      "searchAction": "Buscar",
      "searchLabel": "Buscar entre las entradas",
    ...
    "contact": {
      "email": "Correo",
      "empty": "Todavía no hay datos de contacto publicados.",
    ...
    "faqsPage": {
      "empty": "Todavía no hay preguntas publicadas.",
      "next": "Siguiente",
      "noResults": "No encontramos preguntas para «{query}».",
      "previous": "Anterior",
      "range": "{from, number}-{to, number} de {total, number}",
      "searchAction": "Buscar",
      "searchLabel": "Buscar entre las preguntas",
      "searchPlaceholder": "¿Qué necesitas saber?",
      "subtitle": "Resuelve tus dudas antes de empezar.",
      "title": "Preguntas frecuentes"
    },
    "features": {
      "items": {
    ...
    "latestPosts": {
      "all": "Ver todas las entradas",
      "subtitle": "Lo último que hemos publicado.",
      "title": "Desde el <accent>blog</accent>"
    },
    "nav": {
      "blog": "Blog",
      "contact": "Contacto",
    ...
    "pricingPage": {
      "subtitle": "Empieza gratis y cambia de plan cuando lo necesites. Sin permanencia.",
      "title": "Precios"
    }
  },
  "metadata": {
  ...
  "navigation": {
    "admin": {
      ...
      "plans": "Planes",
      "platform": "Plataforma",
      "publicSite": "Portada y secciones",
      "report": "Reporte",
      "roles": "Roles",
      "settings": "Ajustes",
  ...
  "plans": {
    ...
    "limits": {
      "action": {
        ...
        "image": "Imagen",
        "planner": "Planificador",
        "repurpose": "Reutilización",
        "review": "Revisión",
        "search": "Búsqueda",
        "timing": "Mejor horario",
        "video": "Vídeo"
      },
      "actionCosts": "Coste de créditos por acción",
      "actionCostsHint": "Estos créditos se descuentan después de la franquicia mensual.",
      "aiVideoMaxSeconds": "Vídeo AI máximo (segundos)",
      "channelCountMode": "Conteo de cuentas",
      "creditsPerMonth": "Créditos de IA al mes",
      "hint": "-1 significa ilimitado. Los límites se aplican por workspace.",
      "maxChannels": "Cuentas conectadas",
      "maxFileSizeMb": "Tamaño por archivo (MB)",
      "maxPostsPerMonth": "Posts al mes",
      "maxStorageMb": "Almacenamiento (MB)",
      "maxTeamMembers": "Miembros del equipo",
      "modePerNetwork": "Por cada red",
      "modeTotal": "Total entre todas las redes",
      "module": {
  ...
  "portalPlans": {
    "active": "Activo",
    "annual": "Anual",
    "billingUnavailableDescription": "El catálogo sigue visible, pero Polar debe estar listo antes de aceptar pagos.",
    ...
    "creditsTitle": "Créditos incluidos",
    "currentPlan": "Tu plan actual",
    "currentPlanDescription": "{plan} · Los límites se aplican al workspace activo.",
    "currentPlanFallback": "Plan de alta",
    "features": {
      "channels": "{value} canales conectados",
      "credits": "{value} créditos AI al mes",
      "modules": "{count, plural, one {# módulo incluido} other {# módulos incluidos}}",
      "posts": "{value} publicaciones al mes",
      "storage": "{value} MB de archivos",
      "team": "{value} miembros"
    },
    "free": "Gratis",
    "loadFailedDescription": "No se modificó ningún plan. Vuelve a intentarlo para recuperar el catálogo.",
    "loadFailedTitle": "No pudimos cargar los planes",
    "loading": "Cargando planes",
    "monthly": "Mensual",
    "noPlansDescription": "Activa al menos un plan desde Admin para mostrarlo en el Portal.",
    "noPlansTitle": "No hay planes disponibles",
    "ownerDescription": "Solo el propietario del workspace puede iniciar o modificar una suscripción.",
    "ownerOnly": "Solo propietario",
    "ownerTitle": "Facturación administrada por el propietario",
    ...
    "renewalDescription": "La fecha se sincroniza desde la suscripción verificada.",
    "renewalEndsValue": "Finaliza el {date}",
    "renewalNone": "Sin fecha de renovación",
    ...
    "successBack": "Ver mis planes",
    "successDescription": "Polar confirmó el checkout. El plan se actualizará cuando el webhook verifique la suscripción.",
    "successTitle": "Pago recibido",
    "trialDays": "{count, plural, one {Prueba de # día} other {Prueba de # días}}",
    "unlimited": "Ilimitados",
    "unavailable": "No disponible",
    "workspaceDescription": "El plan y sus límites pertenecen al workspace seleccionado.",
    "workspaceTitle": "Aplicado al workspace"
  },
  "profile": {
    "allFieldsRequired": "Completa todos los campos.",
    "avatarAlt": "Foto de perfil",
    "avatarChange": "Cambiar foto",
    "avatarHint": "JPG, PNG o WebP · cuadrada, ideal 512×512 px · máx. 1 MB",
    "avatarRemove": "Quitar foto",
    "avatarRemoved": "Foto de perfil eliminada.",
    "avatarTooLarge": "La imagen supera 1 MB.",
    "avatarType": "Usa una imagen JPG, PNG o WebP.",
  ...
  "publishing": {
    ...
    "composer": {
      ...
      "captionsDescription": "Inserta un texto reutilizable en la publicación.",
      "captionsEmpty": "Aún no hay captions activos.",
      "captionsTitle": "Captions guardados",
      ...
      "noteSaveFailed": "No pudimos guardar la nota.",
      "noteSaved": "La nota se guardó.",
      ...
      "toolLoadFailed": "No pudimos cargar este recurso.",
      "mode": {
        "draft": "Borrador",
        "now": "Ahora",
        "schedule": "Programar"
