...
declare const messages: {
  ...
  "aiAgents": {
    ...
    "editor": {
      ...
      "model": "Modelo",
      "name": "Nombre",
      "noInputDescription": "Ejecuta los nodos anteriores para ver aquí lo que recibe este agente.",
      "noInputTitle": "Sin datos de entrada",
      "noOutputDescription": "Ejecuta este paso para ver aquí su resultado.",
      "noOutputTitle": "Sin datos de salida",
      "output": "Salida",
