...
11. El ancho del sidebar y el desplazamiento del contenido usan una transición CSS nativa de 300 ms con `ease-in-out`; no usan estado transitorio ni animación JavaScript. El drawer móvil conserva su transición CSS de desplazamiento.
