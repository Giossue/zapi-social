...
11. El ancho del sidebar, el desplazamiento del contenido, las etiquetas, títulos de grupo e iconos usan transiciones CSS de 200 ms con `ease-out`. Los nodos permanecen montados y los iconos se desplazan con `left` y `transform`, evitando cambios instantáneos de alineación. El drawer móvil conserva su transición CSS de desplazamiento.
