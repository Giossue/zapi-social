...
sidebar principal y montada por el shell junto a él. El shell es plano: no usa
el marco inset, borde exterior ni esquinas redondeadas para el contenido. Es
responsive y no añade primitives nuevos.
