...
- Corrección de Portal del 2026-08-13: `CollectionHeader` pasa a ser la única cabecera contextual fuera de card para Support, Teams, RSS, Captions, Publishing, Dashboard y operaciones de AI Studio. Sus `DataTableHeader` contienen solo búsqueda y acción; Channels conserva título y descripción dentro de su tabla como excepción aprobada. `audit:portal-admin-ui` bloquea nuevas regresiones de este tipo.
