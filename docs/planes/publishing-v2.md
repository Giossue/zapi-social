...
1. **Composer contextual:** elegir cuentas primero mediante un multiselect buscable por nombre de cuenta o alias asignado; los filtros de red son botones interactivos y las cuentas ya elegidas se muestran como badges removibles. Agrupa explícitamente texto, **Media** y **Cuándo publicar**: Media mantiene una biblioteca fija, buscable y filtrable por tipo que selecciona desde el almacenamiento mock y sincroniza la preview.
